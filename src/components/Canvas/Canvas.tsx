...
import {TeamWrapper} from "./shared/styled/WrapperTeam/wrapper";
                    ...
                    <ContentWrapper>
                        ...
                        <InfoHolder>
                            {data.avatarsArray?.map((avatar) => (
                                <TextWrapper data-avatar="textWrapper" data-avatarname={`${avatar.name}`}
                                             key={avatar.order}>
                                    <SeparatorWrapper>
                                        <Separator data-avatar="separator" data-avatarname={`${avatar.name}`}/>
                                    </SeparatorWrapper>
                                    <SmallTitle data-avatar="tag" data-animation="paragraph"

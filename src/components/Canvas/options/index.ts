...
export const data: Data = {
  ...
  avatarsArray: [
    ...
    {
      name: "Валерий",
      description: "Приходит играть в тенис",
      imgSrc: asset2.src,
    ...
    {
      name: "Сергей",
      description: "Разработчик MapBiz",
      imgSrc: asset4.src,
    ...
    {
      name: "Максим",
      description: "Любитель гачи однокоренных слов",
      imgSrc: asset5.src,
    ...
    {
      name: "Виталий",
      description: 'Проигрывает Сергею в Тенис',
      imgSrc: asset7.src,
    ...
    {
      name: "Василий",
      description: 'За wordpress готов убивать',
      imgSrc: asset9.src,
    ...
    {
      name: "Юрий 1",
      description: 'Утверждает всем что директор MapBiz',
      imgSrc: asset10.src,

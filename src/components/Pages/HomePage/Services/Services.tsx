...
export default function Services(props) {
    ...
    return (
        <section
            className="h-[calc(100vh-80px)] w-full flex justify-between py-[50px] flex-col max-w-[1280px] mx-auto">
            <div className={'flex justify-end'}>
                <div
                    className="text-white-text-new-mapbiz  text-[60px] max-w-[648px] w-full">
                    <div className="">
            ...
            <div className="services-more flex justify-end font-grotesk">
                <div className="w-full 2xl:w-11/12 grid 2xl:grid-cols-2">
                    ...
                    <div
                        className="services-more__nav font-light flex flex-col items-start md:items-end text-[6.5px] leading-[0.5rem] 2xl:text-sm text-grey-mapbiz">
                        <div
                            ...
                            {subLinks.map((item, index) => {
                                return <Link onClick={() => {
                                    ...
                                    setDataButton(item.data)
                                             ...
                                             className="text-base services-more__el px-2.5 2xl:px-4 py-[0.3rem] 2xl:py-2 border border-greytransparent-mapbiz rounded-[24px] hover:bg-white hover:shadow-white-mapbiz transition duration-300"
                                             href={'/develop'}>{item.title}</Link>
                            })}
                        </div>
                    </div>
                </div>

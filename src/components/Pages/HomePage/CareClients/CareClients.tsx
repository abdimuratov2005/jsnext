            ...
            <div className="w-full 2xl:w-11/12 grid gap-y-4 2xl:gap-y-24">
                ...
                <div className="foryou-grid grid 2xl:grid-cols-2">
                    <div className="">
                        ...
                        <div
                            className="foryou-nav mt-6 flex flex-wrap gap-x-2.5 2xl:gap-x-4 gap-y-3 2xl:gap-y-5  leading-[0.5rem] text-[6.5px] 2xl:text-sm text-grey-mapbiz">
                            {links.map((item) => {
                            ...
                            if (item.id === selectButton) {
                                return (
                                    <div
                                        ...
                                        className={`${styles.image__slider} relative foryou-el flex flex-col justify-center box-border`}>
                                        <div

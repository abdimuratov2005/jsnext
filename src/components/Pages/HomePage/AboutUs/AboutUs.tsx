...
function AboutUs(props) {
    return (
        <div className="about max-w-screen-xl mx-auto pt-24 pb-24 flex justify-end font-grotesk font-light text-white-text-new-mapbiz">
                ...
                <div className="grid gap-y-16 text-2xl leading-9">
                    ...
                    <div className="flex justify-end">
                        <div className="w-full 2xl:w-[48%]">
                            <p>
                                Мы непрерывно находимся в поиске надежных деловых партнеров, благодаря которым наши клиенты получат более широкий комплекс услуг, а мы - больше клиентов.
                            </p>
                            <p className="border-b-[3px] border-greyborder-mapbiz pb-4">

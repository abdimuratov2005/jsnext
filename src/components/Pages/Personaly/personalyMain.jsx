    ...
    return (
        <section className="flex justify-center items-center bg-darkgrey-mapbiz">
            <div className="intro max-w-screen-xl w-full pt-60 pb-36 font-grotesk text-white">
                <h1 className="header-change font-bold text-[4.1rem] text-whitetext-mapbiz">
                    Политика в отношении обработки персональных данных
                </h1>
                <div className="flex mt-36 text-xl">
                    <div className="w-[55%] grid gap-y-8 pr-7">
                        <h2 className="text-2xl font-medium">1. Общие положения</h2>
                        <p>
                            ...
                            безопасности персональных данных, предпринимаемые ИП Пеклич Ю.Е.
                            (далее — Оператор).
                        </p>
                        <p>
                ...
                <div className="grid gap-y-8 text-xl mt-16">
                    ...
                    <p>
                        ...
                        сети интернет по сетевому адресу https://mapbiz-group.com/.
                    </p>
                    <p>
                    ...
                    <p>
                        <span className="font-medium">Цель обработки:</span> информирование
                    ...
                    <p>
                        <span className="font-medium">Правовые основания: </span> Федеральный
        ...
        <span className="font-medium">
          Виды обработки персональных данных:{" "}
                    ...
                    <p>
                        ...
                        уведомление на адрес электронной почты Оператора mapbiz@yandex.ru с
                    ...
                    <p>
                        ...
                        электронный адрес Оператора mapbiz@yandex.ru с пометкой «Отзыв согласия
                    ...
                    <h2 className="text-2xl font-medium">12. Заключительные положения</h2>
                    <p>
                        ...
                        Оператору с помощью электронной почты mapbiz@yandex.ru.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Интернет по адресу https://mapbiz-group.com/personaly.
                    </p>
                </div>
            </div>
        </section>

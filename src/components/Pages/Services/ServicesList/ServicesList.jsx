export default function ServicesList() {
    return (
        <section className="services max-w-screen-xl mx-auto pt-48 pb-56 grid gap-y-40">
            <div className="flex justify-end font-grotesk-light text-6xl leading-[5.5rem] text-white opacity-90">
                <div className="services-fone w-6/12">
                    <img src="assets/images/services/Services-left-phone.png" alt="" />
                </div>
                <div className="services-nav w-6/12 grid gap-y-6 mt-80">
                    ...
                    <div className="services-more__about w-[76%] grid gap-y-10 text-2xl leading-9 text-white">
                        <p>
